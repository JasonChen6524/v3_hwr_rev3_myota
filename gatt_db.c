...
0x73, 0x52, 0x1d, 0x95, 0x7f, 0x65, 0x09, 0xa4, 0xe8, 0x4b, 0x99, 0x7d, 0x0b, 0xef, 0x81, 0x11, 
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_26 ) = {
	.len=19,
	.data={0x14,0x1c,0x00,0xd6,0x58,0xd6,0x21,0xbc,0x55,0x81,0x9f,0x42,0x44,0x71,0x6d,0xc4,0x6e,0xc2,0xfe,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_23 ) = {
	.len=19,
	.data={0x0c,0x19,0x00,0x73,0x52,0x1d,0x95,0x7f,0x65,0x09,0xa4,0xe8,0x4b,0x99,0x7d,0x0b,0xef,0x81,0x11,}
};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x8004,.permissions=0x804,.caps=0xffff,.datatype=0x02,.dynamicdata=&bg_gattdb_data_attribute_field_27},
    {.uuid=0x000e,.permissions=0x807,.caps=0xffff,.datatype=0x03,.configdata={.flags=0x01,.index=0x06,.clientconfig_index=0x01}},
};
